...
const pageStyles = `
  ...
  .my-income-main { flex: 1; min-width: 0; padding: 20px; max-width: 960px; margin: 0 auto; }
                                ...
                                <Fragment key={line._id}>
                                  <tr className={isExpandable ? 'bd-toggle' : ''} style={{ ...(line.status === 'REJECTED' ? { opacity: 0.5 } : {}), ...(isExpandable ? { cursor: 'pointer' } : {}) }}
                                    ...
                                    <td>
                                      ...
                                      {isSchedule && <span style={{ fontSize: 10, color: '#6366f1', marginLeft: 4 }}>(scheduled)</span>}
