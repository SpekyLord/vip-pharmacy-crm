...
const WORKFLOW_GUIDES = {
  ...
  'car-logbook': {
    ...
    steps: [
      ...
      'Phase P1.2 Slice 6 — every day is auto-populated from four sources before you type: SMER daily entry → destination; SMER ODO captures → Start/End KM + photos; DriveAllocation row → Personal/Official KM split; FUEL_ENTRY captures → fuel rows. The colored source badge next to each field tells you where the value came from (SMER, ODO, Drive, Fuel cap, Prior). Edit any field to override → badge flips to red "Manual"',
