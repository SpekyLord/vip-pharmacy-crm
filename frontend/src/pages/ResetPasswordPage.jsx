...
const authStyles = `
  ...
  body.dark-mode .auth-success-btn {
    background: #f59e0b;
    color: rgba(11, 11, 11, 0.95);
  }

  body.dark-mode .auth-success-btn:hover {
    filter: brightness(1.05);
    background: #fbbf24;
  }
    ...
    <div className="login-page">
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <h1>New Password</h1>
          <div className="login-subtitle">Create a new password for your account</div>
        </div>
        ...
        {success ? (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <Link to="/login" className="auth-success-btn">
              Go to Login
            </Link>
          </div>
        ) : (
