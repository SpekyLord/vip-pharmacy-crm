 ...
 *   - MESSAGE_ACCESS_ROLES — per-role DM / broadcast matrix (who can message
 *                            whom). Works WITH the messaging.* ERP_ACCESS
 *                            sub-permissions for the two-layer Phase-3c gate.
 *
