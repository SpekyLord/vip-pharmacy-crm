...
const PAYMENT_MODES = [
  { mode_code: 'CASH', mode_label: 'Cash', mode_type: 'CASH', requires_calf: false },
  { mode_code: 'CHECK', mode_label: 'Check', mode_type: 'CHECK', requires_calf: false },
  { mode_code: 'BANK_TRANSFER', mode_label: 'Bank Transfer', mode_type: 'BANK_TRANSFER', requires_calf: false },
  { mode_code: 'GCASH', mode_label: 'GCash', mode_type: 'GCASH', requires_calf: false },
  { mode_code: 'CC_RCBC', mode_label: 'Credit Card (RCBC)', mode_type: 'CARD', requires_calf: true },
  { mode_code: 'CC_SBC', mode_label: 'Credit Card (SBC)', mode_type: 'CARD', requires_calf: true },
  { mode_code: 'CC_MBTC', mode_label: 'Credit Card (MBTC)', mode_type: 'CARD', requires_calf: true },
  { mode_code: 'CC_UB', mode_label: 'Credit Card (UB)', mode_type: 'CARD', requires_calf: true },
];
